...
<div class="mx-auto max-w-5xl">
	...
	<div>
		<h1 class="text-2xl font-700 tracking-tight">
			...
			{:else}
				Welcome to <span class="text-accent">VASH</span>
			{/if}
		</h1>
	...
	<div class="mt-8 grid grid-cols-3 gap-4">
		...
		<div class="col-span-1">
			...
			<div class="mt-3 flex flex-col gap-2">
				...
				>
					<span class="flex h-8 w-8 items-center justify-center rounded-md bg-accent/10 text-accent">⚔</span>
					<div>
				...
				<a
					...
					class="flex items-center gap-3 rounded-lg border border-border bg-surface-800 p-3 transition-colors hover:border-accent/40 hover:bg-surface-700"
				>
					<span class="flex h-8 w-8 items-center justify-center rounded-md bg-purple-500/10 text-purple-400">♫</span>
					<div>
				...
				<a
					...
					class="flex items-center gap-3 rounded-lg border border-border bg-surface-800 p-3 transition-colors hover:border-accent/40 hover:bg-surface-700"
				>
					<span class="flex h-8 w-8 items-center justify-center rounded-md bg-blue-500/10 text-blue-400">⚑</span>
					<div>
			...
			<div class="mt-3 flex flex-col gap-2">
				...
				{:else}
					<div class="rounded-lg border border-dashed border-border py-8 text-center">
						<p class="text-sm text-text-secondary">No matches yet. <a href="/matches" class="text-accent hover:underline">Create one</a></p>
					</div>
				{/each}
			</div>
		</div>
